...
public class qna12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qna12);
        addListenerOnButton();
    }
        ...
        btnDisplay.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectedId==R.id.radio3){
                    Toast.makeText(qna12.this,
                            radioButton.getText() + " is correct answer", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(getApplicationContext(), qna13.class));
