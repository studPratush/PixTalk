...
public class counting4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_counting4);
        addListenerOnButton();
    }
        ...
        btnDisplay.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectedId==R.id.radio1){
                    Toast.makeText(counting4.this,
                            radioButton.getText() + " is correct answer", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(getApplicationContext(), counting5.class));
