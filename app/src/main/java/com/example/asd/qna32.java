...
public class qna32 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qna32);
        addListenerOnButton();
    }
        ...
        btnDisplay.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectedId==R.id.radio3){
                    Toast.makeText(qna32.this,
                            radioButton.getText() + " is correct answer", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(getApplicationContext(), qna33.class));
